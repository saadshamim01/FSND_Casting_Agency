...
class CapstoneTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #self.database_path = "postgres://{}@{}/{}".format('saadshamim', 'localhost:5432', self.database_name)
...
#        res = self.client().patch('/actors/1', json={'name':'Rober Downney Jr.'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 401)
#        self.assertEqual(data['success'], False)
...
#        res = self.client().patch('/movies/1', json={'title':'Age of Ultron'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 401)
#        self.assertEqual(data['success'], False)
...
#        res = self.client().patch('/actors/1', headers={'Authorization': f'Bearer {BASIC}'}, json={'name':'Rober Downney Jr.'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 403)
#        self.assertEqual(data['success'], False)
...
#
#    def test_403_post_movie_authorization_permission_not_found(self):
#        res = self.client().patch('/movies/1', headers={'Authorization': f'Bearer {BASIC}'}, json={'title':'Age of Ultron'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 403)
#        self.assertEqual(data['success'], False)
...
#        res = self.client().delete('/actors/1', headers={'Authorization': f'Bearer {INTERMEDIATE}'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 403)
#        self.assertEqual(data['success'], False)
...
#        res = self.client().delete('/movies/1', headers={'Authorization': f'Bearer {INTERMEDIATE}'})
#        data = json.loads(res.data)
#
#        self.assertEqual(res.status_code, 403)
#        self.assertEqual(data['success'], False)
